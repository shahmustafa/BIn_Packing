...
env_arg.add_argument('--num_applications', type=int, default=4, help='applications number')
env_arg.add_argument('--time_application', type=int, help='application time constraints')
env_arg.add_argument('--weights', type=int, help='Weights')
